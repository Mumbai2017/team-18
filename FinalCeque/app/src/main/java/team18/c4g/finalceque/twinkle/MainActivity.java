...
import team18.c4g.finalceque.SelectSubjectActivity;
import team18.c4g.finalceque.UploadImageOrVideo;
        ...
        api.insertUser(
                ...
                new Callback<Response>() {
                    ...
                    public void success(retrofit.client.Response response, retrofit.client.Response response2)
                    {
                        ...
                        Intent in = new Intent(MainActivity.this,UploadImageOrVideo.class);
